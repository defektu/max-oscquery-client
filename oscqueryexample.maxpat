        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 392.0, 179.0, 66.0, 22.0 ],
                    "text": "disconnect"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 358.5, 145.0, 191.0, 22.0 ],
                    "text": "connect http://192.168.1.107:9010"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 340.0, 71.5, 84.0, 22.0 ],
                    "text": "autoconnect 1"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "text": "connect http://localhost:5679"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 567.0, 346.0, 79.0, 22.0 ],
                    "text": "route running"
                }
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 726.0, 359.0, 400.0, 220.0 ],
                    "viewvisibility": 1
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 504.0, 411.0, 117.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 140.0, 60.0, 66.0, 22.0 ],
                    "text": "script start"
                }
            },
            {
